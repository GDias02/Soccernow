module pt.ul.fc.di.css.javafxexample {
    ...
    opens pt.ul.fc.di.css.javafxexample.controller.utilizadores to javafx.fxml;
    opens pt.ul.fc.di.css.javafxexample.controller.equipas to javafx.fxml;
    opens pt.ul.fc.di.css.javafxexample.controller.jogos to javafx.fxml;
    opens pt.ul.fc.di.css.javafxexample.controller.campeonatos to javafx.fxml;
