...
public class JogoMapper {
    ...
    public static JogoDto jogoToDto(Jogo jogo) {
        ...
        jogoDto.setEquipaDeArbitros(jogo.getEquipaDeArbitros().stream().map(ArbitroMapper::arbitroToDto).collect(Collectors.toList()));
        jogoDto.setDiaEHora(jogo.getDiaEHora());
        jogoDto.setEstadoAtual(jogo.getEstadoAtual());
        jogoDto.setLocal(localToDto(jogo.getLocal()));
    ...
    public static Jogo dtoToJogo(JogoDto jogodto) {
        ...
        jogo.setEquipaDeArbitros(jogodto.getEquipaDeArbitros().stream().map(ArbitroMapper::dtoToArbitro).collect(Collectors.toList()));
        jogo.setDiaEHora(jogodto.getDiaEHora());
        jogo.setEstadoAtual(jogodto.getEstadoAtual());
        jogo.setLocal(dtoToLocal(jogodto.getLocal()));
    ...
    private static Selecao dtoToSelecao(SelecaoDto s) {
        ...
        selecao.setEquipa(EquipaMapper.dtoToEquipa(s.getEquipa()));
