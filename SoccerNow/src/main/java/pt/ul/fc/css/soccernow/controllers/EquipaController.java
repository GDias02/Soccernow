...
import pt.ul.fc.css.soccernow.dto.errors.ErrorDto;
...
public class EquipaController {
    ...
    public ResponseEntity<Dto> verificarEquipa(@PathVariable("id") long id){
        Dto equipa = equipaHandler.verificarEquipa(id);
        if (equipa == null) {
    ...
    public ResponseEntity<Dto> removerEquipa(@PathVariable("id") long id){
        Dto equipa = equipaHandler.removerEquipa(id);
        if (equipa == null) {
            return ResponseEntity.notFound().build();
        } else if (((EquipaDto) equipa).getId() == -1){
    ...
    public ResponseEntity<Dto> atualizarEquipa(@PathVariable("id") long id, @RequestBody EquipaDto equipaDto) {
        Dto equipa = equipaHandler.atualizarEquipa(id, equipaDto);
        if (equipa == null) {
            return ResponseEntity.notFound().build();
        } else if (((EquipaDto) equipa).getId() == -1){
            return ResponseEntity.status(HttpStatus.CONFLICT)
    ...
    public ResponseEntity<List<? extends Dto>> verificarEquipas(){
        List<? extends Dto> equipas = equipaHandler.verificarEquipas();
    ...
    public ResponseEntity<Dto> registarEquipa(@RequestBody EquipaDto equipaDto){
        Dto equipa = equipaHandler.registarEquipa(equipaDto);
        if (equipa == null) {
    ...
    public ResponseEntity<List<? extends Dto>> verificarConquistas(@PathVariable("id") long id){
        List<? extends Dto> conquistas = conquistaHandler.verificarConquistas(id);
    ...
    public ResponseEntity<Dto> verificarConquista(@PathVariable("id") long id, @PathVariable("conquistaId") long conquistaId){
        Dto conquista = conquistaHandler.verificarConquista(id, conquistaId);
        if (conquista == null) {
            return ResponseEntity.notFound().build();
        }
    ...
    public ResponseEntity<Dto> registarConquista(@PathVariable("id") long id, @RequestBody ConquistaDto conquistaDto){
        Dto conquista = conquistaHandler.registarConquista(id, conquistaDto);
        if (conquista == null) {
            return ResponseEntity.badRequest().build();
        } else if (((ConquistaDto) conquista).getId() == -1){
            return ResponseEntity.status(HttpStatus.CONFLICT)
                                .body(null);
        }
        return ResponseEntity.ok(conquista);
    ...
    public ResponseEntity<Dto> removerConquista(@PathVariable("id") long id, @PathVariable("conquistaId") long conquistaId){
        Dto conquista = conquistaHandler.removerConquista(id, conquistaId);
        if (conquista == null) {
            return ResponseEntity.notFound().build();
        }
        return ResponseEntity.ok(conquista);
    ...
    public ResponseEntity<Dto> atualizarConquista(@PathVariable("id") long id, @PathVariable("conquistaId") long conquistaId, @RequestBody ConquistaDto conquistaDto){
        Dto conquista = conquistaHandler.atualizarConquista(id, conquistaId, conquistaDto);
        if (conquista == null) {
            return ResponseEntity.notFound().build();
        } else if (((ConquistaDto) conquista).getId() == -1){
            return ResponseEntity.status(HttpStatus.CONFLICT)
