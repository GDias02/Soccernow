...
public class EstatisticaMapper {
    public static EstatisticaJogoDto estatisticaJogoToDto(EstatisticaJogo stat){
        ...
        statDto.setCartoes(stat.getCartoes().stream().map(CartaoMapper::cartaoToDto).collect(Collectors.toSet()));
        statDto.setGolos(stat.getGolos().stream().map(GoloMapper::goloToDto).collect(Collectors.toSet()));
        return statDto;
    }
    ...
    public static EstatisticaJogo dtoToEstatisticaJogo(EstatisticaJogoDto stats) {
        ...
        stat.setCartoes(stats.getCartoes().stream().map(CartaoMapper::dtoToCartao).collect(Collectors.toSet()));
